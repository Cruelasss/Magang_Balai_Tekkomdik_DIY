...
const FOOTER_PROGRAMS = ['Mahasiswa', 'Siswa SMK'];
const FOOTER_COMPANY = ['Tentang Kami', 'Kontak'];
        ...
        <div className="space-y-8">
          ...
          <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm border border-blue-200 rounded-full px-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 cursor-pointer">
            ...
            <span className="text-sm font-medium bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
              Ayo Magang Bersama Balai Tekkomdik DIY
            </span>
          ...
          <div className="flex items-center gap-6 pt-6">
            ...
            <div className="text-sm text-gray-600">
              <span className="font-bold text-gray-900">100 +</span> Mahasiswa dan Siswa SMK telah bergabung
            </div>
          </div>
        </div>
          ...
          <div className="relative w-full h-[500px] group">
            ...
            <div className="absolute -bottom-8 -right-8 bg-white rounded-2xl shadow-2xl p-4 animate-float-slow animation-delay-2000">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-gray-900">Magang Bersertifikat Resmi</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-3xl p-12 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
              Bergabunglah bersama Tekkomdik Intern-Gate dan kembangkan potensi Anda melalui pengalaman kerja nyata di dunia teknologi pendidikan.
            </p>
            <Link
              to="/register"
        ...
        <div>
          ...
          <ul className="space-y-3">
            {FOOTER_CONTACT.map((item, index) => {
              const Icon = item.icon;
              return (
                <li key={index} className="flex items-center gap-3 text-gray-500 group/item">
                  <Icon className="w-4 h-4 group-hover/item:text-blue-600 transition-colors" />
      ...
      {items.map((item) => (
        <li key={item}>
          <a href="#" className="text-gray-500 hover:text-blue-600 text-sm transition-all duration-300 hover:translate-x-2 inline-block">
            {item === 'Mahasiswa' ? `Magang ${item}` : item}
          </a>
        </li>
      ))}
    </ul>
